    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-background to-secondary/20 flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground mb-8 max-w-2xl">
          Test your REST APIs with our interactive platform. Generate sample data, validate responses, and enhance your API testing workflow.
        </p>
...
const features = [
  {
    ...
    description: "Test your APIs with an intuitive interface and real-time feedback",
    icon: () => (
  ...
  },
  {
    ...
    description: "Generate sample data based on your API requirements",
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Analyze API responses with our beautiful JSON viewer",
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
